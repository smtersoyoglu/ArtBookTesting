...
import com.sametersoyoglu.artbooktesting.databinding.FragmentImageApiBinding
...
class ImageApiFragment @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // search(arama) yerinin kodlarını delay gecikme vererek yapma kodları
        var job : Job? = null
        ...
        viewModel.imageList.observe(viewLifecycleOwner, Observer {
            when(it.status) {
                Status.SUCCESS -> {
                    ...
                    // eğer succes ise aldığımız url yi recycleradapter içerisindeki images listemize verme
